...
import java.math.BigDecimal; // For price, if it changes type, but DTO uses Integer for now
...
public class LessonDto {
    ...
    // Optional: Fields for parsed time components and remaining spots, if this DTO needs to be self-contained for frontend
    // These would typically be populated by the service layer during the mapping from the Lesson entity
    ...
    // For now, commenting out as its current form is incomplete for new Lesson entity.
    /* 
